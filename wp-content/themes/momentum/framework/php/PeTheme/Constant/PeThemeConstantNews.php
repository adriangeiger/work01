...
class PeThemeConstantNews {
	public $metabox;

	public function __construct() {
		$this->metabox = 
			array(
				  "title" =>__("News",'Pixelentity Theme/Plugin'),
				  "priority" => "core",
				  "where" => 
				  array(
						"page" => "page-news",
				  ...
				  array(
						...
						array(
							  ...
							  "type"=>"RadioUI",
							  "description" => __("Select the required post layout. 'Full' - denotes a full width normal news layout. 'Compact' - denotes a full width list style layout. 'Mini' - denotes a compressed layout with small post thumbnails.",'Pixelentity Theme/Plugin'),
							  "options" => PeGlobal::$config["news"],
							  "default"=>""
							  ),
						"count" =>
						array(
		...
		if (count(PeGlobal::$config["news"]) < 2) {
