...
class PeThemeShortcodeBS_News extends PeThemeShortcode {
	...
	public function __construct($master) {
		...
		$this->name = __("News",'Pixelentity Theme/Plugin');
		$this->description = __("News",'Pixelentity Theme/Plugin');

		$options =& peTheme()->content->getPagesOptionsByTemplate("news");
		...
		$this->fields = array(
							  ...
							  array(
									...
									"type" => "Select",
									"description" => __("Show all posts with default options or use custom settings of a news page template.",'Pixelentity Theme/Plugin'),
									"options" => $options
									),
							  "size" => 
							  array(
