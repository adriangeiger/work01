<form action="<?php echo esc_url(home_url("/")); ?>" class="clearfix">
	<input name="s" id="s" type="text" class="search form-control" placeholder="<?php _e(" SUCHEN..",'Pixelentity Theme/Plugin'); ?>" value="<?php echo get_search_query() ? get_search_query() : ""; ?>" />
